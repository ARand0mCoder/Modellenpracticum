...
path1 = r'C:\Users\XpsBook\Documents\Radboud Universiteit Nijmegen\Jaar 3\Modellenpracticum\Bestanden Alliander\Power Data\Uilenburg_1_2018_clean.csv'
...
power1, time1, timeDiff1 = Dv.read_data(path1)
power2, time2, timeDiff2 = Dv.read_data(path2)

power1 = np.transpose(np.array(power1))
power2 = np.transpose(np.array(power2))

power1 = Dv.auto_trim(power1, rows_to_trim1, timeDiff1)
power2 = Dv.auto_trim(power2, rows_to_trim2, timeDiff2)
#%%
power = []
for row in power1:
